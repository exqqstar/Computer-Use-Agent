...
def main():
    ...
    parser.add_argument("--api-base", type=str, default=None, help="Custom API base URL for the LLM provider")
    parser.add_argument("--api-key", type=str, default=None, help="Custom API key for the LLM provider")
    ...
    completion_kwargs = {
        ...
        "api_base": args.api_base or os.getenv("AGENT_API_BASE"),
